-- ============================================================
-- 0009: Only auction players the room can actually recognise
--
-- League crawling filled the catalog with squad filler nobody can name from
-- a silhouette, which makes the guessing game pointless. `notable` marks the
-- curated set, and round selection draws only from it.
-- Safe to re-run.
-- ============================================================
...
create index if not exists idx_players_notable
  on public.players (position_type) where notable;
